    ...
    <div className="max-w-7xl relative z-1 mx-auto px-6 py-20 md:py-32">
      <div className="max-w-3xl">
        ...
        className="flex items-center gap-2 bg-white/5 border justify-center border-white/10 w-fit px-4 py-2 rounded-full mb-8 backdrop-blur-sm">
          ...
          <span className="text-cream/80 font-nunito md:text-sm text-xs font-medium tracking-wide uppercase">Oil & Gas Trading</span>
        </motion.div>
        <motion.h1
        ...
        className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
          Energizing Global Markets with Integrity
        </motion.h1>
        <motion.p
        initial={fromBottomToTop.initial}
        whileInView={fromBottomToTop.whileInView}
        ...
        className="text-xl text-cream/70 mb-8 leading-relaxed">
          Thymus Energy FZCO is a leading bulk petroleum trading company specializing in Fuel Oil, Gas Oil, VGO, Naphtha, and Bitumen. Headquartered in DMCC, Dubai, we connect refineries and end-users across global markets with handling expertise and over 250,000 CBM of strategic storage.
        </motion.p> 
        <motion.div
            initial={fromBottomToTop.initial}
        whileInView={fromBottomToTop.whileInView}
