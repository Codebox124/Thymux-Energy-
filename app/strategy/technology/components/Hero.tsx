    ...
    <div className="max-w-7xl relative z-1 mx-auto px-6 py-20 md:py-32">
      <div className="max-w-3xl">
        ...
        className="flex items-center gap-2 bg-white/5 border justify-center border-white/10 w-fit px-4 py-2 rounded-full mb-8 backdrop-blur-sm">
          ...
          <span className="text-cream/80 font-nunito md:text-sm text-xs font-medium tracking-wide uppercase">Digital Innovation</span>
        </motion.div>
        <motion.h1
        ...
        className="text-xl text-cream/70 mb-8 leading-relaxed">
          At Thymus Energy, we leverage advanced trading platforms and digital transformation to enhance efficiency, transparency, and agility in every transaction across global energy markets.
        </motion.p>
         <motion.div
            initial={fromBottomToTop.initial}
        whileInView={fromBottomToTop.whileInView}
