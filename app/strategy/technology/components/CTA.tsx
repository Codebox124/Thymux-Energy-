    ...
    <div className="max-w-7xl mx-auto px-6 py-20">
      <div className="bg-gray-100 rounded-3xl p-12 md:p-16 text-center">
        ...
        transition={{
          ...
          className="text-lg text-gray-600 max-w-2xl mx-auto mb-7">
          Discover how our digital platforms can streamline your petroleum trading operations and provide competitive advantages.
        </motion.p>
        <motion.button
        initial={fromBottomToTop.initial}
        whileInView={fromBottomToTop.whileInView}
