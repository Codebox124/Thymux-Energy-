...
const mediaItems = [
  {
    ...
    date: "Jan 12, 2026",
    description:
      "Thymus Energy strengthens its regional infrastructure with expanded onshore storage operations in Basra, supporting faster cargo turnaround and greater supply flexibility across the Gulf.",
    image:
  ...
  },
  {
    id: 4,
    category: "News",
    title: "Thymus Energy Strengthens Ties with Key Gulf Refineries",
    date: "Dec 10, 2025",
    description:
      "Thymus Energy announces deepened supply agreements with major refineries across the Arabian Gulf, securing long-term access to Fuel Oil, Gas Oil, and VGO cargoes.",
    image:
  ...
  },
  {
    id: 5,
    category: "Innovation",
    title: "Digital Trading Platforms: Enhancing Transparency in Petroleum Markets",
    date: "Dec 01, 2025",
    description:
      "Thymus Energy continues to invest in advanced trading platforms that enhance efficiency, market transparency, and real-time cargo tracking for clients across global markets.",
    image:
